...
pub enum SectionType {
    ...
    //arm
    ARM_EXIDX           = 0x70000001, // Exception unwind tables
    ARM_PREEMPTMAP      = 0x70000002, // BPABI DLL dynamic linking pre-emption map
    ARM_ATTRIBUTES      = 0x70000003, // Object file compatibility attributes
